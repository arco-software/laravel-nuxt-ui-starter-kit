...
declare global {
  ...
  const getError: typeof import('./resources/js/composables/getError')['default']
  const getErrors: typeof import('./resources/js/composables/getErrors')['default']
  ...
  const randomFrom: typeof import('./resources/js/utils/index')['randomFrom']
  const randomInt: typeof import('./resources/js/utils/index')['randomInt']
  ...
  const useFillInForm: typeof import('./resources/js/composables/useFillInForm')['default']
  const useFillInObjects: typeof import('./resources/js/composables/useFillInObjects')['default']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly randomFrom: UnwrapRef<typeof import('./resources/js/utils/index')['randomFrom']>
    readonly randomInt: UnwrapRef<typeof import('./resources/js/utils/index')['randomInt']>
